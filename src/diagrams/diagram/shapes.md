...
{% tab template="diagram/shapes/Text", isDefaultActive=true %}
...
{% tab template="diagram/shapes/Image", isDefaultActive=true %}
...
{% tab template="diagram/shapes/Native", isDefaultActive=true %}
...
{% tab template="diagram/shapes/Basic", isDefaultActive=true %}
...
{% tab template="diagram/shapes/Path", isDefaultActive=true %}
...
{% tab template="diagram/shapes/Flow", isDefaultActive=true %}
