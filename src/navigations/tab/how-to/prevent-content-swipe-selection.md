...
We can prevent the tab selection on touch swipe action by using the Tab [`selecting`](../../api/tab#selecting) event.
Refer the below sample with preventing swipe selection.

{% tab template="tab/how-to/swipe-selection", isDefaultActive=true %}
