...
component: "Tab"
description: "This example demonstrates how to customize the scrolling distance of Essentail JS 2 Tab items when clicking left or right navigation icons."
---
...
{% tab template="tab/how-to/scrollstep" %}

```html
<template>
    <div id="app">
    <ejs-tab id='element' scrollStep='50'>
        <e-tabitems>
