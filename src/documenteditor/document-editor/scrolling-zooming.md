...
<template>
    <div id="app">
        <ejs-documenteditor ref="documenteditor" :enableSelection='true' :isReadOnly=false style="width: 100%;height: 100%;"></ejs-documenteditor>
    </div>
</template>
<script>
import Vue from 'vue'
...
export default {
    ...
    mounted: function() {
        this.$refs.documenteditor.fitPage('Fit page width');
    }
}
</script>
<style>
...
<template>
    <div id="app">
        <ejs-documenteditor ref="documenteditor" v-bind:selectionChange='onSelectionChange' v-bind:viewChange='onViewChange' v-bind:documentChange='onDocumentChange' :enableSelection='true' :isReadOnly=false style="width: 100%;height: 100%;"></ejs-documenteditor>
