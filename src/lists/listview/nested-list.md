...
component: "ListView"
description: "Vue listView supports nested listview used to display a set of nested list items in different layouts."
---
...
{% tab template="listview/nested-list", isDefaultActive=true  %}
