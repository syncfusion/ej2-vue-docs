# Essential JS 2 for Vue

Essential JS 2 for Vue is a collection modern TypeScript based true vue Components.
 All the components are developed from the ground up to be lightweight, responsive, modular and touch friendly.
