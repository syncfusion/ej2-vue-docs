...
Chart can be given a title using [`title`](../api/stock-chart/#title-string) property, to show the information about the data plotted.

{% tab template="stockchart/appearance",  iframeHeight="500px" %}
